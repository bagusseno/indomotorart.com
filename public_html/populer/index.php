...
<html>
  <head>
    <meta charset="utf-8">
    <title>Foto-Foto Populer - IndoMotorStyle</title>
  </head>
  <body>
...
?>
  ...
  $(document).ready(function() {
    ...
    $("#trend").html("");
    showPost("trend", newLimit, "trend", "Maaf! Tidak ditemukan foto populer.", newStart);
    newStart += newLimit;
    printed += newLimit;
      ...
      console.log(outRes);
        ...
        if(newStarted == 1) {
          if(outRes != 0 && printed < 20) {
            showPost("trend", newLimit, "trend", newMsg, newStart, "msg-endpost");
            printed += newLimit;
          }
          if(outRes != 0 && printed >= 20) {
  ...
  <?php } else { ?>
    $("#trend").html("");
    showPost("trend", newLimit, "trend", "Maaf! Tidak ditemukan foto baru.", newStart);
    newStart += newLimit;
    printed += newLimit;
    $(window).scroll(function() {
      console.log(outRes);
